...
from exchange.kyc.base import BaseKYCProvider
from exchange.merchants import update_merchants_config
from exchange.reposiroty.utils import create_superuser, TokenAuth
...
class TestAccounts(LiveServerTestCase):
    ...
    def test_account_kyc_2_schema(self):
        ...
        resp1 = requests.post(
            url,
            json={
                'provider_class': 'exchange.kyc.FakeKYCProvider',
                'document': base64.b64encode(b'1').decode(),
                'selfie': base64.b64encode(b'2').decode()
            },
            headers=self.headers
